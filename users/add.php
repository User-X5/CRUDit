...
if (isset($userData['btn'])) {
    ...
    $insertQuery = "INSERT INTO users VALUES(null, '$name' , '$password' ,$role_id , null)";
...
<section class="w-100 bg-section py-5">
    <h1 class="text-center fw-bold text-white text-uppercase">Users Add</h1>
                ...
                <form action="" method="POST" class="form-container text-white fw-bold text-uppercase">
                    ...
                    <div class=" mb-3">
                        ...
                        <select class="form-select" name="role_id" id="role_id">
                            <?php foreach($selectRolesResult as $item) {?>
