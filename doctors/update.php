...
if (isset($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    $selectQuery = "SELECT * FROM doctors WHERE id = $edit_id";
...
if (isset($_POST['btn'])) {
    ...
    $updateQuery = "UPDATE doctors SET name= '$name' , age = $age , address = '$address', salary = $salary WHERE id = $id";
...
<section class="w-100 bg-section py-5">
    <h1 class="text-center fw-bold text-white text-uppercase">Doctor Update</h1>
        ...
        <div class="row justify-content-evenly animate__animated animate__fadeIn">
            <div class="col-6">
                <form action="" method="POST" class="form-container text-white fw-bold text-uppercase">
                    ...
                    <input type="text" name="name" required value="<?php echo $name ?>" class="form-control" id="exampleInputEmail1"">
                    </div>
                    <div class=" mb-3">
                    <label for="exampleInputEmail1" class="form-label">age</label>
                    <input type="number" name="age" required value="<?php echo $age ?>" class="form-control" id="exampleInputEmail1"">
                    </div>
                    <div class=" mb-3">
                    <label for="exampleInputEmail1" class="form-label">address</label>
                    <input type="text" name="address" required value="<?php echo $address ?>" class="form-control" id="exampleInputEmail1"">
                    </div>
                    <div class=" mb-3">
                    <label for="exampleInputEmail1" class="form-label">salary</label>
                    <input type="text" name="salary" required value="<?php echo $salary ?>" class="form-control" id="exampleInputEmail1"">
                    </div>
