...
if (isset($_GET['edit'])) {
    $edit_id = $_GET['edit'];
    $selectQuery = "SELECT * FROM departments WHERE id = $edit_id";
...
<section class="w-100 bg-section py-5">
    <h1 class="text-center fw-bold text-white text-uppercase">Department Update</h1>
        ...
        <div class="row justify-content-evenly animate__animated animate__fadeIn">
            <div class="col-6">
                <form action="" method="POST" class="form-container text-white fw-bold text-uppercase">
                    ...
                    <button class="btn btn-primary back-button"><a href="../departments/department.php" class="w-100 h-100 text-white ">Back</a></button>
            </div>
            </form>
        </div>
    </div>
