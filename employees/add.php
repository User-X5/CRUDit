...
if (isset($Data['btn'])) {
    ...
    $insertQuery = "INSERT INTO employees VALUES(null, '$name' , $age ,$salary, $department_id)";
...
<section class="w-100 bg-section py-5">
    <h1 class="text-center fw-bold text-white text-uppercase">Employee Add</h1>
            ...
            <div class="col-6">
                <form action="" method="POST" class="form-container text-white fw-bold text-uppercase">
                    ...
                    <div class=" mb-3">
                        ...
                        <input type="number" required name="salary" class="form-control" id="salary"">
                    </div>
                    ...
                    <div class=" mb-3">
                        ...
                        <select class="form-select" id="department" name="department_id">
                            <option selected disabled null>Select One</option>
                            <?php foreach ($selectResultDe as $department) { ?>
