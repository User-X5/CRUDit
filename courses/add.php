...
if (isset($Data['btn'])) {
    ...
    $insertQuery = "INSERT INTO courses VALUES(null, '$name' , $price ,$hours)";
...
<section class="w-100 bg-section py-5">
    <h1 class="text-center fw-bold text-white text-uppercase">Course Add</h1>
            ...
            <div class="col-6">
                <form action="" method="POST" class="form-container text-white fw-bold text-uppercase">
                    ...
                    <div class=" mb-3">
                        ...
                        <input type="number" name="hours" required class="form-control" id="hours"">
                    </div>
